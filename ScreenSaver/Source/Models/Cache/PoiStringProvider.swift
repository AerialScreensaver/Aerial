...
final class PoiStringProvider {
    ...
    private func loadBundle() {
        // Idle string bundle
        var bundlePath = Cache.supportPath.appending("/Sources/macOS 26")
        ...
        if let sb = Bundle.init(path: bundlePath) {
            let dictPath = Cache.supportPath.appending("/Sources/macOS 26/TVIdleScreenStrings.bundle/en.lproj/Localizable.nocache.strings")
