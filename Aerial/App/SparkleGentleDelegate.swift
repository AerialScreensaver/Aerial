...
final class SparkleGentleDelegate: NSObject, ObservableObject, SPUUpdaterDelegate, SPUStandardUserDriverDelegate {
    ...
    func standardUserDriverWillHandleShowingUpdate(
        ...
        // Dock badge — in the menu-bar presentation this temporarily
        // shows the app in the Dock so the badge is visible; in the
        // Dock presentation the icon is already there.
        AppPresentationController.shared.setUpdateAvailable(true)

        // Change menu-bar icon to attention state
        AppPresentationController.shared.setIcon(mode: .notification)
    ...
    func standardUserDriverDidReceiveUserAttention(forUpdate update: SUAppcastItem) {
        ...
        AppPresentationController.shared.setUpdateAvailable(false)
        AppPresentationController.shared.setIcon(mode: .notification)
