...
struct Thumbnails {
    ...
    nonisolated(unsafe) private static var inFlight: [String: [(NSImage?) -> Void]] = [:]   // guarded by inFlightLock
    ...
    private static func generateFromFirstFrame(_ video: AerialVideo) {
        do {
            ...
            if video.isAvailableOffline {
                ...
                if PrefsVideos.videoFormat.isHDR && video.sourceFor(format: PrefsVideos.videoFormat).name.starts(with: "tvOS") {
