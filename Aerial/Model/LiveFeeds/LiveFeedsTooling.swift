...
final class LiveFeedsTooling {
    ...
    /// Ships alongside ffmpeg in every install method we probe. Used by
    /// the My Videos importer to check codecs before an mkv/webm remux.
