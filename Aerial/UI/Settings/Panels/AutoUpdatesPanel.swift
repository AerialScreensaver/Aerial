                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        HStack {
                            Text("Channel")
                                .font(.system(size: 13))
                            Spacer()
                            Text(betaUpdates ? "Beta" : "Stable")
                                .font(.system(size: 13, weight: .medium))
                                .foregroundColor(betaUpdates ? .orange : .secondary)
                        }
                        ...
                        HStack {
                            Text("Browse the release history and what changed in each version.")
                                .font(.system(size: 12))
                                .foregroundColor(.secondary)
                            Spacer()
                            Button("What's New...") {
